(function initAppStateModule(global) {
  ...
  function createInitialState() {
    return {
      ...
      accountDisplayName: localStorage.getItem('chatAccountDisplayName') || '',
      accountDisplayMode: localStorage.getItem('chatAccountDisplayMode') === 'nickname' ? 'nickname' : 'id',
      accountProfiles: JSON.parse(localStorage.getItem('chatAccountProfiles') || '{}'),
      ws: null,
      current: null,
